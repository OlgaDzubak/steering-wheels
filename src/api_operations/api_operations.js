...
export async function getAllCategoriesAndPhotos(language='ua', category='', abortCtrl) {
      
      const { data } = await axios.get(`/all?language=${language}&category=${category}`, {signal: abortCtrl.signal});
      return data;
}
