...
`,ma=D.h2`
    ...
    clip: rect(0 0 0 0);
    overflow: hidden;
`,ha=p.lazy(()=>nt(()=>import("./Gallery-9a34f831.js"),["assets/Gallery-9a34f831.js","assets/index-0ef5a075.js"])),va=({language:t})=>b.jsx("main",{children:b.jsx("section",{children:b.jsxs(fa,{children:[b.jsx(ma,{children:U.galleryTitle[t]}),b.jsx(ha,{language:t})]})})}),ga=D.footer`
  padding-top: 30px;
  padding-bottom: 30px;
  box-shadow: 0px -2px 0px 0px  var(--shadow-color);
`,xa=D.div`
