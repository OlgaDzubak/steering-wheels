import{g as yn,s as Fn,h as On,r as p,E as Dn,c as In,_ as C,a as An,n as D,j as b,b as Mn}from"./index-f44b885a.js";var $t={exports:{}},P={};/** @license React v16.13.1
...
`,no=({language:n,onLanguageChange:e})=>{const i=(r,t)=>{e(r.value)};return b.jsx(ka,{children:b.jsxs(Ha,{children:[b.jsxs(Wa,{children:[b.jsx(Ya,{children:Y.title[n]}),b.jsx(qa,{children:Y.subTitle[n]})]}),b.jsxs(Ga,{children:[b.jsxs(Ka,{children:[b.jsxs("address",{children:[b.jsx(Za,{children:Y.address[n]}),b.jsxs(Xa,{children:[b.jsx(Rt,{children:b.jsx(Tt,{href:"tel:+38(097)678-13-96","aria-label":"Telephone us at 38-097-678-13-96",children:"+38 (097) 678-13-96"})}),b.jsx(Rt,{children:b.jsx(Tt,{href:"tel:+38(050)531-92-76","aria-label":"Telephone us at 38-050-531-92-76",children:"+38 (050) 531-92-76"})})]})]}),b.jsxs(Ja,{children:[b.jsx(ke,{children:b.jsx(He,{href:"https://www.instagram.com/nataha9754","aria-label":"Write to us on Instagram",target:"_blank",rel:"noopener noreferrer",children:b.jsx(Qa,{})})}),b.jsx(ke,{children:b.jsx(He,{href:"viber://chat?number=%2B380976781396","aria-label":"Write to us on Viber",target:"_blank",rel:"noopener noreferrer",children:b.jsx(eo,{})})}),b.jsx(ke,{children:b.jsx(He,{href:"https://t.me/NatashaLatash","aria-label":"Write to us on Telegram",target:"_blank",rel:"noopener noreferrer",children:b.jsx(to,{})})})]})]}),b.jsxs(za,{children:[b.jsx(Na,{htmlFor:"language-input",hidden:!0,children:"Language"}),b.jsx(_a,{inputId:"language-input",name:"languages",isSearchable:!1,placeholder:n,options:[{value:"ua",label:"ua"},{value:"ru",label:"ru"}],onChange:i,styles:Ua(),"aria-label":"Select site language"})]})]})]})})},io=D.div`
  padding-left  : var(--container-padding);
  padding-right : var(--container-padding);
  padding-top   : 30px;
  padding-bottom: 30px;
`,ro=D.h2`
    ...
    clip: rect(0 0 0 0);
    overflow: hidden;
`,ao=p.lazy(()=>Mn(()=>import("./Gallery-c78af3a0.js"),["assets/Gallery-c78af3a0.js","assets/index-f44b885a.js"])),oo=({language:n})=>b.jsx("main",{children:b.jsx("section",{children:b.jsxs(io,{children:[b.jsx(ro,{children:Y.galleryTitle[n]}),b.jsx(ao,{language:n})]})})}),uo=D.footer`
  padding-top: 30px;
  padding-bottom: 30px;
  box-shadow: 0px -2px 0px 0px  var(--shadow-color);
`,so=D.div`
...
`,bo=D(En)`
    ...
    width: 20px;
    fill: var(--text-color);
`,Eo=({language:n})=>b.jsx(uo,{children:b.jsxs(so,{children:[b.jsxs(lo,{children:[b.jsx(co,{children:Y.title[n]}),b.jsx(po,{children:Y.subTitle[n]})]}),b.jsxs(fo,{children:[b.jsxs("address",{children:[b.jsx(ho,{children:Y.address[n]}),b.jsxs(mo,{children:[b.jsx(Bt,{children:b.jsx(jt,{href:"tel:+38(097)678-13-96","aria-label":"Telephone us at 38-097-678-13-96",children:"+38 (097) 678-13-96"})}),b.jsx(Bt,{children:b.jsx(jt,{href:"tel:+38(050)531-92-76","aria-label":"Telephone us at 38-050-531-92-76",children:"+38 (050) 531-92-76"})})]})]}),b.jsxs(vo,{children:[b.jsx(ze,{children:b.jsx(Ne,{href:"https://www.instagram.com/direct/t/17849474219500467","aria-label":"Write to us on Instagram",target:"_blank",rel:"noopener noreferrer",children:b.jsx(go,{})})}),b.jsx(ze,{children:b.jsx(Ne,{href:"viber://chat?number=%2B380976781396","aria-label":"Write to us on Viber",target:"_blank",rel:"noopener noreferrer",children:b.jsx(xo,{})})}),b.jsx(ze,{children:b.jsx(Ne,{href:"https://t.me/NatashaLatash","aria-label":"Write to us on Telegram",target:"_blank",rel:"noopener noreferrer",children:b.jsx(bo,{})})})]})]})]})}),wo=()=>{const[n,e]=Gn("language","ua");p.useEffect(()=>{n==="ua"||n==="ru"||e("ua"),document.querySelector("html").setAttribute("lang",Y.metaLang[n]),document.querySelector('meta[name="description"]').setAttribute("content",Y.metaDescription[n]),document.querySelector("title").textContent=Y.pageTitle[n]},[n]);const i=r=>{e(r)};return b.jsxs(b.Fragment,{children:[b.jsx(no,{language:n,onLanguageChange:i}),b.jsx(oo,{language:n}),b.jsx(Eo,{language:n})]})},yo=Object.freeze(Object.defineProperty({__proto__:null,default:wo},Symbol.toStringTag,{value:"Module"}));export{yo as H,Y as c,Wn as k,So as m};
